...
class bb9:
    ...
    def __init__(self,data=0,dark=0,bs=0,sc_f=np.array([4.533e-5,1.99e-5,1.946e-5,1.615e-5,1.682e-5,1.047e-5,9.738e-6,8.375e-6,6.404e-6])
    ...
    #implement a lambda function to calculate bs, this doesn't work yet
    def back_scat(self):
        dark = self.dark
        data = self.data
        sc_f = self.sc_f
        self.bs = data.apply(lambda x: sc_f*(x-dark),axis=1)
